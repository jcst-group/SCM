<template>
    <div class="insurance-apply">
        ...
        <checkInsuranceApply ref="checkInsuranceApply"></checkInsuranceApply>
    </div>
</template>

<script>
import tableMixin from '@/mixins/tableMixin'
import checkInsuranceApply from '../modules/InsuranceModules/checkInsuranceApply'
...
export default {
    ...
    methods: {
        ...
        handleEdit(record) {
            this.$refs.checkInsuranceApply.open(record)
        }
    }
}
</script>
