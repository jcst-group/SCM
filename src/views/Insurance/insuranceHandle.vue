    ...
    <div class="insurance-apply">
        <div class="content-title">
            <div class="content-desc">
                *此处汇总已受理的保险申请，您可以选择查看并完善信息。
            </div>
            <div class="search-wrapper">
                <div class="search-desc">
                   *按申请类型查询
                </div>
                <a-radio-group @change="e => this.changeRadio(e, 'insuranceType')" name="radioGroup" :value="insuranceType">
                    <a-radio
        ...
        <checkInsuranceHandle ref="checkInsuranceHandle"></checkInsuranceHandle>
    </div>
</template>

<script>
import tableMixin from '@/mixins/tableMixin'
import checkInsuranceHandle from '../modules/InsuranceModules/checkInsuranceHandle'
import {insuranceList} from '@/api/insuranceApi'
import {getInsuranceType} from '@/api/allApi'
export default {
    mixins: [tableMixin],
    components: {
        checkInsuranceHandle
    },
    data() {
        return {
            insuranceUnit: '',
    ...
    methods: {
        ...
        handleEdit(record) {
            this.$refs.checkInsuranceHandle.open(record)
        }
    }
}
</script>
