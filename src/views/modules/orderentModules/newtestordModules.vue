<template>
    <a-modal :title="title" v-model="visible"  style="top:5%;height: 90%"
             :maskClosable="false" class="newtestord-modal">
        <a-form :form="form">
            <div>
...
<style lang="stylus">
    ...
    .tab-box01 /deep/ .ant-form-item
        margin-bottom: 5px;
    .newtestord-modal /deep/ .ant-modal-body
        overflow-y: inherit;
        max-height 517px !important;
    .newtestord-modal /deep/ .ant-btn-default
        display: none
    .newtestord-modal /deep/ .ant-modal-footer
        display none
    .newtestord-modal /deep/ .ant-btn-primary
        background-color #0F5D67
        border-color #0F5D67
    .newtestord-modal /deep/ .ant-modal-body
        overflow auto
    .newtestord-modal /deep/ .ant-checkbox-group-item
        margin-bottom 10px
</style>
