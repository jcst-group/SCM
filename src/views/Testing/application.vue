    ...
    <div class="application">
        <div class="content-title">
            <div class="content-desc">
                *此处汇总了各大合作社的检测申请需求，<br>您可以根据贵公司的检测服务内容进行承接相应检测。
            </div>
            <a-form
                :form="form"
        ...
        <changeOrderModule ref="changeOrderModule"></changeOrderModule>
    </div>
</template>
...
import changeOrderModule from '../modules/TestingModules/changeOrderModule'
export default {
    mixins: [tableMixin],
    components: {
        changeOrderModule
    ...
    methods: {
        ...
        _loadData() {
            ...
            params.detectStatus = "DETECT_CONFIRM"
        ...
        handleEdit(record) {
            this.$refs.changeOrderModule.open(record)
        }
    }
}
</script>
